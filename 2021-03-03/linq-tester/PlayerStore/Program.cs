...
namespace PlayerStore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FilesRepository<Player> playersRepository = new FilesRepository<Player>("players.json");
            FilesRepository<Team> teamsRepository = new FilesRepository<Team>("teams.json");
